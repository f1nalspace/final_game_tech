...
## 0. Handover (Stand 2026-09-26, Iteration 6 bis auf die Windows-Abnahme)
...
- **Win32-Tastenzustand pro physischer Taste** statt pro VK-Code (1.3): L/R-Umschalt, Strg und Alt im Nachrichtenweg sowie Enter und Ziffernblock-Enter teilen sich heute einen Eintrag. Für qemu wichtig, weil sonst ein Drücken ohne Loslassen beim Gast ankommt. Möglich über den Scancode als Schlüssel für `keyStates` unter Win32. Dazu kommt die bekannte Windows-Eigenheit, dass bei zwei gedrückten Umschalttasten das erste Loslassen gar nicht gemeldet wird (SDL gleicht das über `GetKeyState` ab).
