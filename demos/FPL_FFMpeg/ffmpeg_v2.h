...
// CExtern
#ifndef FFMPEG_CEXTERN
#ifdef __cplusplus
#define FFMPEG_CEXTERN extern "C"
#define FFMPEG_CEXTERN_START() extern "C" {
#define FFMPEG_CEXTERN_END() }
#else
#define FFMPEG_CEXTERN
#define FFMPEG_CEXTERN_START()
#define FFMPEG_CEXTERN_END()
#endif
#endif // FFMPEG_CEXTERN

// API keyword (extern or static)
#ifndef FFMPEG_API
#if defined(FFMPEG_PRIVATE)
#define FFMPEG_API FFMPEG_CEXTERN static
#else
#define FFMPEG_API FFMPEG_CEXTERN extern
#endif
#endif // FFMPEG_API
...
#define FFMPEG_AVFORMAT_FREE_CONTEXT_FUNC(name) void name(AVFormatContext *s)
typedef FFMPEG_AVFORMAT_FREE_CONTEXT_FUNC(ffmpeg_avformat_free_context_func);
// avformat_seek_file
...
// avcodec_get_name
#define FFMPEG_AVCODEC_GET_NAME_FUNC(name) const char *name(enum AVCodecID id)
typedef FFMPEG_AVCODEC_GET_NAME_FUNC(ffmpeg_avcodec_get_name_func);
...
// av_dict_get
#define FFMPEG_AV_DICT_GET_FUNC(name) AVDictionaryEntry *name(const AVDictionary *m, const char *key, const AVDictionaryEntry *prev, int flags)
typedef FFMPEG_AV_DICT_GET_FUNC(ffmpeg_av_dict_get_func);
// av_dict_count
#define FFMPEG_AV_DICT_COUNT_FUNC(name) int name(const AVDictionary *m)
typedef FFMPEG_AV_DICT_COUNT_FUNC(ffmpeg_av_dict_count_func);
// av_dict_set
#define FFMPEG_AV_DICT_SET_FUNC(name) int name(AVDictionary **pm, const char *key, const char *value, int flags)
typedef FFMPEG_AV_DICT_SET_FUNC(ffmpeg_av_dict_set_func);
// av_dict_set_int
#define FFMPEG_AV_DICT_SET_INT_FUNC(name) int name(AVDictionary **pm, const char *key, int64_t value, int flags)
typedef FFMPEG_AV_DICT_SET_INT_FUNC(ffmpeg_av_dict_set_int_func);
// av_dict_free
#define FFMPEG_AV_DICT_FREE_FUNC(name) void name(AVDictionary **m)
typedef FFMPEG_AV_DICT_FREE_FUNC(ffmpeg_av_dict_free_func);
// av_dict_copy
#define FFMPEG_AV_DICT_COPY_FUNC(name) int name(AVDictionary **dst, const AVDictionary *src, int flags)
typedef FFMPEG_AV_DICT_COPY_FUNC(ffmpeg_av_dict_copy_func);
// av_dict_get_string
#define FFMPEG_AV_DICT_GET_STRING_FUNC(name) int name(const AVDictionary *m, char **buffer, const char key_val_sep, const char pairs_sep)
typedef FFMPEG_AV_DICT_GET_STRING_FUNC(ffmpeg_av_dict_get_string_func);
// av_reduce
#define FFMPEG_AV_REDUCE_FUNC(name) int name(int *dst_num, int *dst_den, int64_t num, int64_t den, int64_t max)
typedef FFMPEG_AV_REDUCE_FUNC(ffmpeg_av_reduce_func);
...
typedef struct FFMPEGContext {
	...
	ffmpeg_avformat_free_context_func* avformat_free_context;
	...
	ffmpeg_avcodec_get_name_func *avcodec_get_name;
	...
	ffmpeg_av_dict_get_func *av_dict_get;
	ffmpeg_av_dict_count_func *av_dict_count;
	ffmpeg_av_dict_set_func *av_dict_set;
	ffmpeg_av_dict_set_int_func *av_dict_set_int;
	ffmpeg_av_dict_free_func *av_dict_free;
	ffmpeg_av_dict_copy_func *av_dict_copy;
	ffmpeg_av_dict_get_string_func *av_dict_get_string;
	ffmpeg_av_reduce_func *av_reduce;
...
#if defined(FFMPEG_IMPLEMENTATION) && !defined(FFMPEG_IMPLEMENTED)
...
static bool _IsFFMPEGVersionEqual(int a, int b) {
...
static fplDynamicLibraryHandle _FFMPEGLoadLibrary(const char* filePath) {
...
#define _FFMPEG_CONCAT_SO(name, version) name _FFMPEG_STR(version)
#define _FFMPEG_CONCAT_DLL(name, version, ext) name _FFMPEG_STR(version) ext

#if !USE_FFMPEG_STATIC_LINKING
	
#	if defined(FPL_PLATFORM_WINDOWS)
	const char* avFormatLibFile = _FFMPEG_CONCAT_DLL("avformat-", LIBAVFORMAT_VERSION_MAJOR, ".dll");
	const char* avCodecLibFile = _FFMPEG_CONCAT_DLL("avcodec-", LIBAVCODEC_VERSION_MAJOR, ".dll");
	const char* avUtilLibFile = _FFMPEG_CONCAT_DLL("avutil-", LIBAVUTIL_VERSION_MAJOR, ".dll");
	const char* swScaleLibFile = _FFMPEG_CONCAT_DLL("swscale-", LIBSWSCALE_VERSION_MAJOR, ".dll");
	const char* swResampleLibFile = _FFMPEG_CONCAT_DLL("swresample-", LIBSWRESAMPLE_VERSION_MAJOR, ".dll");
#	else
	const char *avFormatLibFile = _FFMPEG_CONCAT_SO("libavformat.so.", LIBAVFORMAT_VERSION_MAJOR);
	const char *avCodecLibFile = _FFMPEG_CONCAT_SO("libavcodec.so.", LIBAVCODEC_VERSION_MAJOR);
	const char *avUtilLibFile = _FFMPEG_CONCAT_SO("libavutil.so.", LIBAVUTIL_VERSION_MAJOR);
	const char *swScaleLibFile = _FFMPEG_CONCAT_SO("libswscale.so.", LIBSWSCALE_VERSION_MAJOR);
	const char *swResampleLibFile = _FFMPEG_CONCAT_SO("libswresample.so.", LIBSWRESAMPLE_VERSION_MAJOR);
#	endif // FPL_PLATFORM_WINDOWS

	fplDynamicLibraryHandle avFormatLib = ffmpeg->avFormatLib = _FFMPEGLoadLibrary(avFormatLibFile);
	fplDynamicLibraryHandle avCodecLib = ffmpeg->avCodecLib = _FFMPEGLoadLibrary(avCodecLibFile);
	fplDynamicLibraryHandle avUtilLib = ffmpeg->avUtilLib = _FFMPEGLoadLibrary(avUtilLibFile);
	fplDynamicLibraryHandle swScaleLib = ffmpeg->swScaleLib = _FFMPEGLoadLibrary(swScaleLibFile);
	fplDynamicLibraryHandle swResampleLib = ffmpeg->swResampleLib = _FFMPEGLoadLibrary(swResampleLibFile);
...
#undef _FFMPEG_STR_HELPER
#undef _FFMPEG_STR
#undef _FFMPEG_CONCAT_SO
#undef _FFMPEG_CONCAT_DLL

//
// AVFormat
//
#if !USE_FFMPEG_STATIC_LINKING
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avformat_version, ffmpeg_get_lib_version_func, "avformat_version");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avformat_network_init, ffmpeg_avformat_network_init_func, "avformat_network_init");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avformat_network_deinit, ffmpeg_avformat_network_deinit_func, "avformat_network_deinit");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avformat_close_input, ffmpeg_avformat_close_input_func, "avformat_close_input");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avformat_open_input, ffmpeg_avformat_open_input_func, "avformat_open_input");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avformat_find_stream_info, ffmpeg_avformat_find_stream_info_func, "avformat_find_stream_info");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->av_dump_format, ffmpeg_av_dump_format_func, "av_dump_format");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->av_read_frame, ffmpeg_av_read_frame_func, "av_read_frame");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avformat_alloc_context, ffmpeg_avformat_alloc_context_func, "avformat_alloc_context");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avformat_free_context, ffmpeg_avformat_free_context_func, "avformat_free_context");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avformat_seek_file, ffmpeg_avformat_seek_file_func, "avformat_seek_file");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avformat_match_stream_specifier, ffmpeg_avformat_match_stream_specifier_func, "avformat_match_stream_specifier");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->av_find_best_stream, ffmpeg_av_find_best_stream_func, "av_find_best_stream");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->av_guess_sample_aspect_ratio, ffmpeg_av_guess_sample_aspect_ratio_func, "av_guess_sample_aspect_ratio");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->av_guess_frame_rate, ffmpeg_av_guess_frame_rate_func, "av_guess_frame_rate");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->av_read_pause, ffmpeg_av_read_pause_func, "av_read_pause");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->av_read_play, ffmpeg_av_read_play_func, "av_read_play");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avio_feof, ffmpeg_avio_feof_func, "avio_feof");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->av_find_program_from_stream, ffmpeg_av_find_program_from_stream_func, "av_find_program_from_stream");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->av_format_inject_global_side_data, ffmpeg_av_format_inject_global_side_data_func, "av_format_inject_global_side_data");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avio_size, ffmpeg_avio_size_func, "avio_size");
	_FFMPEG_GET_FUNCTION_ADDRESS(avFormatLib, avFormatLibFile, ffmpeg->avio_seek, ffmpeg_avio_seek_func, "avio_seek");
#else
	...
	ffmpeg->avformat_free_context = avformat_free_context;
	...
	//
#if !USE_FFMPEG_STATIC_LINKING
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avcodec_version, ffmpeg_get_lib_version_func, "avcodec_version");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avcodec_free_context, ffmpeg_avcodec_free_context_func, "avcodec_free_context");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avcodec_alloc_context3, ffmpeg_avcodec_alloc_context3_func, "avcodec_alloc_context3");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avcodec_parameters_to_context, ffmpeg_avcodec_parameters_to_context_func, "avcodec_parameters_to_context");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avcodec_find_decoder, ffmpeg_avcodec_find_decoder_func, "avcodec_find_decoder");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avcodec_open2, ffmpeg_avcodec_open2_func, "avcodec_open2");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avcodec_receive_frame, ffmpeg_avcodec_receive_frame_func, "avcodec_receive_frame");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avcodec_send_packet, ffmpeg_avcodec_send_packet_func, "avcodec_send_packet");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->av_packet_alloc, ffmpeg_av_packet_alloc_func, "av_packet_alloc");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->av_packet_free, ffmpeg_av_packet_free_func, "av_packet_free");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->av_packet_ref, ffmpeg_av_packet_ref_func, "av_packet_ref");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->av_packet_unref, ffmpeg_av_packet_unref_func, "av_packet_unref");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->av_new_packet, ffmpeg_av_new_packet_func, "av_new_packet");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avsubtitle_free, ffmpeg_avsubtitle_free_func, "avsubtitle_free");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avcodec_find_decoder_by_name, ffmpeg_avcodec_find_decoder_by_name_func, "avcodec_find_decoder_by_name");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->av_packet_move_ref, ffmpeg_av_packet_move_ref_func, "av_packet_move_ref");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avcodec_flush_buffers, ffmpeg_avcodec_flush_buffers_func, "avcodec_flush_buffers");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avcodec_decode_subtitle2, ffmpeg_avcodec_decode_subtitle2_func, "avcodec_decode_subtitle2");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->av_rdft_init, ffmpeg_av_rdft_init_func, "av_rdft_init");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->av_rdft_calc, ffmpeg_av_rdft_calc_func, "av_rdft_calc");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->av_rdft_end, ffmpeg_av_rdft_end_func, "av_rdft_end");
	_FFMPEG_GET_FUNCTION_ADDRESS(avCodecLib, avCodecLibFile, ffmpeg->avcodec_get_name, ffmpeg_avcodec_get_name_func, "avcodec_get_name");	
#else
	...
	ffmpeg->avcodec_get_name = avcodec_get_name;
#endif
	...
	//
#if !USE_FFMPEG_STATIC_LINKING
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->avutil_version, ffmpeg_get_lib_version_func, "avutil_version");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_frame_alloc, ffmpeg_av_frame_alloc_func, "av_frame_alloc");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_frame_free, ffmpeg_av_frame_free_func, "av_frame_free");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_frame_unref, ffmpeg_av_frame_unref_func, "av_frame_unref");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_frame_move_ref, ffmpeg_av_frame_move_ref_func, "av_frame_move_ref");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_image_get_buffer_size, ffmpeg_av_image_get_buffer_size_func, "av_image_get_buffer_size");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_image_get_linesize, ffmpeg_av_image_get_linesize_func, "av_image_get_linesize");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_image_fill_arrays, ffmpeg_av_image_fill_arrays_func, "av_image_fill_arrays");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_gettime_relative, ffmpeg_av_gettime_relative_func, "av_gettime_relative");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_gettime, ffmpeg_av_gettime_func, "av_gettime");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_get_media_type_string, ffmpeg_av_get_media_type_string_func, "av_get_media_type_string");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_rescale_q, ffmpeg_av_rescale_q_func, "av_rescale_q");
	...
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_compare_ts, ffmpeg_av_compare_ts_func, "av_compare_ts");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_get_bytes_per_sample, ffmpeg_av_get_bytes_per_sample_func, "av_get_bytes_per_sample");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_get_sample_fmt_name, ffmpeg_av_get_sample_fmt_name_func, "av_get_sample_fmt_name");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_log_set_flags, ffmpeg_av_log_set_flags_func, "av_log_set_flags");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_log, ffmpeg_av_log_func, "av_log");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_get_pix_fmt_string, ffmpeg_av_get_pix_fmt_string_func, "av_get_pix_fmt_string");	
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_get_pix_fmt_name, ffmpeg_av_get_pix_fmt_name_func, "av_get_pix_fmt_name");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_fifo_write, ffmpeg_av_fifo_write_func, "av_fifo_write");	
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_fifo_alloc2, ffmpeg_av_fifo_alloc2_func, "av_fifo_alloc2");	
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_fifo_read, ffmpeg_av_fifo_read_func, "av_fifo_read");	
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_fifo_freep2, ffmpeg_av_fifo_freep2_func, "av_fifo_freep2");	
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_dict_get, ffmpeg_av_dict_get_func, "av_dict_get");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_dict_count, ffmpeg_av_dict_count_func, "av_dict_count");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_dict_set, ffmpeg_av_dict_set_func, "av_dict_set");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_dict_set_int, ffmpeg_av_dict_set_int_func, "av_dict_set_int");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_dict_free, ffmpeg_av_dict_free_func, "av_dict_free");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_dict_copy, ffmpeg_av_dict_copy_func, "av_dict_copy");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_dict_get_string, ffmpeg_av_dict_get_string_func, "av_dict_get_string");
	_FFMPEG_GET_FUNCTION_ADDRESS(avUtilLib, avUtilLibFile, ffmpeg->av_reduce, ffmpeg_av_reduce_func, "av_reduce");
#else
	...
	ffmpeg->av_dict_get = av_dict_get;
	ffmpeg->av_dict_count = av_dict_count;
	ffmpeg->av_dict_set = av_dict_set;
	ffmpeg->av_dict_set_int = av_dict_set_int;
	ffmpeg->av_dict_free = av_dict_free;
	ffmpeg->av_dict_copy = av_dict_copy;
	ffmpeg->av_dict_get_string = av_dict_get_string;
	ffmpeg->av_reduce = av_reduce;
#endif
	...
	//
#if !USE_FFMPEG_STATIC_LINKING
	_FFMPEG_GET_FUNCTION_ADDRESS(swScaleLib, swScaleLibFile, ffmpeg->swscale_version, ffmpeg_get_lib_version_func, "swscale_version");
	_FFMPEG_GET_FUNCTION_ADDRESS(swScaleLib, swScaleLibFile, ffmpeg->sws_getContext, ffmpeg_sws_getContext_func, "sws_getContext");
	_FFMPEG_GET_FUNCTION_ADDRESS(swScaleLib, swScaleLibFile, ffmpeg->sws_scale, ffmpeg_sws_scale_func, "sws_scale");
	_FFMPEG_GET_FUNCTION_ADDRESS(swScaleLib, swScaleLibFile, ffmpeg->sws_freeContext, ffmpeg_sws_freeContext_func, "sws_freeContext");
	_FFMPEG_GET_FUNCTION_ADDRESS(swScaleLib, swScaleLibFile, ffmpeg->sws_getCachedContext, ffmpeg_sws_getCachedContext_func, "sws_getCachedContext");
#else
	...
	//
#if !USE_FFMPEG_STATIC_LINKING
	_FFMPEG_GET_FUNCTION_ADDRESS(swResampleLib, swResampleLibFile, ffmpeg->swresample_version, ffmpeg_get_lib_version_func, "swresample_version");
	_FFMPEG_GET_FUNCTION_ADDRESS(swResampleLib, swResampleLibFile, ffmpeg->swr_alloc_set_opts2, ffmpeg_swr_alloc_set_opts2_func, "swr_alloc_set_opts2");
	_FFMPEG_GET_FUNCTION_ADDRESS(swResampleLib, swResampleLibFile, ffmpeg->swr_free, ffmpeg_swr_free_func, "swr_free");
	_FFMPEG_GET_FUNCTION_ADDRESS(swResampleLib, swResampleLibFile, ffmpeg->swr_convert, ffmpeg_swr_convert_func, "swr_convert");
	_FFMPEG_GET_FUNCTION_ADDRESS(swResampleLib, swResampleLibFile, ffmpeg->swr_init, ffmpeg_swr_init_func, "swr_init");
	_FFMPEG_GET_FUNCTION_ADDRESS(swResampleLib, swResampleLibFile, ffmpeg->swr_set_compensation, ffmpeg_swr_set_compensation_func, "swr_set_compensation");
#else
	...
	// Check versions
	_FFMPEG_CHECK_VERSION("AVformat", avFormatLibFile, ffmpeg->avformat_version, LIBAVFORMAT_VERSION_INT);
	_FFMPEG_CHECK_VERSION("AVcodec", avCodecLibFile, ffmpeg->avcodec_version, LIBAVCODEC_VERSION_INT);
	_FFMPEG_CHECK_VERSION("AVutil", avUtilLibFile, ffmpeg->avutil_version, LIBAVUTIL_VERSION_INT);
