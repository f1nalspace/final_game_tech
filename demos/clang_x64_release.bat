...
rmdir /s /q %BUILD_DIR%
mkdir %BUILD_DIR%
clang -std=c++11 -Weverything %IGNORED_WARNINGS% -DFPL_RELEASE -s -O2 -I..\ -lkernel32.lib -o%BUILD_DIR%\FPL_Console.exe FPL_Console\fpl_console.cpp > %BUILD_DIR%\clang_error.txt 2>&1